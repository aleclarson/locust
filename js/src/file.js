...
(function() {
  var Finder, NODE_PATHS, NamedFunction, _findDepPath, _installMissing, _unshiftContext, async, basename, define, dirname, extname, inArray, isAbsolute, isKind, join, log, lotus, plural, ref, ref1, ref2, relative, setType, spawn, sync,
    slice = [].slice;
  ...
  ref1 = require("type-utils"), isKind = ref1.isKind, setType = ref1.setType;
